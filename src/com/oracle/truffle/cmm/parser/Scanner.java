...
public class Scanner {
	...
	static {
		...
		for (int i = 99; i <= 122; ++i) start.set(i, 1);
		...
		literals.put("const", new Integer(18));
		literals.put("void", new Integer(20));
		literals.put("if", new Integer(25));
		literals.put("else", new Integer(26));
		literals.put("while", new Integer(27));
		literals.put("for", new Integer(28));
		literals.put("print", new Integer(29));
		literals.put("println", new Integer(30));
		literals.put("return", new Integer(31));
		literals.put("true", new Integer(35));
		literals.put("false", new Integer(36));
		literals.put("read", new Integer(37));
		literals.put("readln", new Integer(38));
		literals.put("length", new Integer(39));
		...
		loop: for (;;) {
			switch (state) {
				...
				case 2:
					{t.kind = 3; break loop;}
				case 3:
					if (ch <= 8 || ch >= 11 && ch <= 12 || ch >= 14 && ch <= '&' || ch >= '(' && ch <= '[' || ch >= ']' && ch <= 65535) {AddCh(); state = 4; break;}
				...
				case 5:
					if (ch == 39 || ch == 92 || ch == 'n' || ch == 'r' || ch == 't') {AddCh(); state = 4; break;}
					else {state = 0; break;}
				case 6:
					{t.kind = 5; break loop;}
				case 7:
				...
				case 8:
					if (ch == 92 || ch == 'n' || ch == 'r' || ch == 't') {AddCh(); state = 7; break;}
					else {state = 0; break;}
				case 9:
					{t.kind = 6; break loop;}
				case 10:
				...
				case 22:
					...
					else if (ch == 'f') {AddCh(); state = 2; break;}
					else if (ch == 'E') {AddCh(); state = 23; break;}
					else {t.kind = 4; break loop;}
				case 23:
					if (ch >= '0' && ch <= '9') {AddCh(); state = 24; break;}
					else if (ch == '+' || ch == '-') {AddCh(); state = 25; break;}
					else {state = 0; break;}
				case 24:
					recEnd = pos; recKind = 4;
					if (ch >= '0' && ch <= '9') {AddCh(); state = 24; break;}
				...
				case 43:
					...
					else if (ch == 'a') {AddCh(); state = 44; break;}
					else {t.kind = 1; t.val = new String(tval, 0, tlen); CheckLiteral(); return t;}
				case 44:
					recEnd = pos; recKind = 1;
					if (ch >= '0' && ch <= '9' || ch >= 'A' && ch <= 'Z' || ch >= 'a' && ch <= 'j' || ch >= 'l' && ch <= 'z') {AddCh(); state = 1; break;}
					else if (ch == 'k') {AddCh(); state = 45; break;}
					else {t.kind = 1; t.val = new String(tval, 0, tlen); CheckLiteral(); return t;}
				case 45:
					recEnd = pos; recKind = 1;
					if (ch >= '0' && ch <= '9' || ch >= 'A' && ch <= 'Z' || ch >= 'a' && ch <= 'z') {AddCh(); state = 1; break;}
