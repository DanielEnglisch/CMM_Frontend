...
public class Parser {
	...
	boolean isVarDecl() {
		if (la.kind == _ident || la.val.equals("int") || la.val.equals("float") || la.val.equals("char")) {
			...
			while (x.kind != _semicolon) {
				if (x.kind == _EOF || x.kind == _lpar || x.kind == _assign)
					return false;
				x = scanner.Peek();
			}
			return true;
	...
	boolean isExpr() {
		if (la.kind == _bang)
			...
			while (x.kind != _rpar && x.kind != _EOF) {
				if (x.kind == _eql || x.kind == _neq || x.kind == _lss || x.kind == _leq || x.kind == _gtr
						|| x.kind == _geq)
					return false;
				x = scanner.Peek();
			}
	...
	NodeList ProcDecl() {
		...
		currProc.locals = tab.curScope.locals;
		tab.closeScope();
	...
	Struct Type() {
		...
		if (la.kind == 23) {
			...
			if (len <= 0) {
				SemErr("Length of array can't be less than 1!");
			}
	...
	Node Statement() {
		...
		NodeList act_nl;
		int line = -1;
		Node des_n, exp_n, con_n, stm_n1, stm_n2, stm_n3, stm_n4;
		stm_n = null;
		...
		case 1: {
			...
			if (la.kind == 10) {
				...
				} else if (!isCompatible(des_n.type.kind, exp_n.type.kind)) {
				...
				line = la.line;
				act_nl = ActPars();
				if (des_n.type != Tab.noType)
					SemErr("Designator must be void!");
		...
		case 28: {
			...
			Expect(9);
			Node op_n = Statement();
			if (ass_n.kind != Node.ASSIGN || ass_n.kind == Node.STATSEQ) {
				SemErr("Invalid for loop! Check Initializer!");
			}
			if (op_n.kind == Node.STATSEQ) {
				SemErr("Operator can't be a block!");
			}
	...
	Node Designator() {
		...
		if (la.kind == 23) {
			...
			exp_n = Expr();
			Struct type = null;
			if (o.type.kind == Struct.STRING) {
				type = Tab.charType;
			} else if (o.type.kind == Struct.ARR) {
				type = o.type.elemType;
			} else {
				SemErr("Invalid Designator Type (must be string or array)!");
			}
			if (exp_n.type.kind != Struct.INT) {
				SemErr("Index must be of type INT!");
			}
	...
	Node Expr() {
		...
		while (la.kind == 39 || la.kind == 40) {
			...
			} else if (trm_n1.type.kind == Struct.STRING && trm_n2.type.kind == Struct.STRING) {
				exp_n = new Node(operator, trm_n1, trm_n2, trm_n1.type);
				trm_n1 = exp_n;
			} else
	...
	Node Factor() {
		...
		if (la.kind == 1) {
			...
			if (la.kind == 7) {
				act_nl = ActPars();
				if (des_n.kind != Node.IDENT) {
					SemErr("Designator must have no structure!");
				} else {
					if (des_n.obj.kind != Obj.PROC) {
						SemErr("Designator must be of kind PROC but " + des_n.obj.name + " is"
								+ des_n.obj.getKindName(des_n.obj.kind) + "!");
					} else if (des_n.obj.type.kind == Struct.NONE) {
						SemErr("Designator can't be of type void!");
					} else
	...
	private static final boolean[][] set = {
			...
			{ _x, _T, _x, _x, _x, _x, _x, _x, _x, _T, _x, _x, _x, _x, _x, _x, _x, _x, _T, _x, _x, _T, _x, _x, _x, _T,
					_x, _T, _T, _T, _T, _T, _x, _x, _x, _x, _x, _x, _x, _x, _x, _x, _x, _x, _x, _x },
			{ _x, _T, _x, _x, _x, _x, _x, _x, _x, _T, _x, _x, _x, _x, _x, _x, _x, _x, _x, _x, _x, _T, _x, _x, _x, _T,
					_x, _T, _T, _T, _T, _T, _x, _x, _x, _x, _x, _x, _x, _x, _x, _x, _x, _x, _x, _x },
			{ _x, _x, _x, _x, _x, _x, _x, _T, _T, _T, _T, _T, _T, _T, _T, _T, _T, _x, _x, _T, _x, _x, _x, _x, _T, _x,
					_x, _x, _x, _x, _x, _x, _T, _T, _x, _x, _x, _x, _x, _T, _T, _T, _T, _T, _x, _x },
			{ _x, _T, _T, _T, _T, _T, _T, _T, _x, _x, _x, _x, _x, _x, _x, _x, _x, _x, _x, _x, _x, _x, _x, _x, _x, _x,
					_x, _x, _x, _x, _x, _x, _x, _x, _T, _T, _T, _T, _T, _T, _x, _x, _x, _x, _x, _x }
